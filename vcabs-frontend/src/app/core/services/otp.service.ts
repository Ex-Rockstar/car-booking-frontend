...
export class OtpService {
  ...
  verify(email: string, otp: string): Observable<string> {
    return this.http.post(`${this.base}/verifyotp/${encodeURIComponent(email)}/${encodeURIComponent(otp)}`, {}, { responseType: 'text' });
  }
}
